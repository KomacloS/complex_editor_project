...
class Repository:
    ...
    def context(self) -> AppContext:
        """Expose the shared :class:`AppContext` instance."""
    ...
    def new_complex(
        ...
        *,
        ...
        """Create an unsaved complex shell for the UI workflows."""

        alias_list = list(aliases or [])
        identifier = f"new-{uuid.uuid4().hex}"
        return Complex(
            identifier=identifier,
            part_number=part_number,
            alternate_part_numbers=list(alias_list),
            aliases=alias_list,
